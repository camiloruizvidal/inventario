...
<html lang="en">
    ...
    <head>
        ...
        <script language="javascript" type="text/javascript" src="//code.jquery.com/jquery-2.2.3.min.js"></script>
                            ...
                            <div class="info-box">
                                <div class="row-fluid stats-box">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="stats-box-all-info"><i class="icon-thumbs-up"  style="color:#F30"></i> 56.316</div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="stats-box-all-info"><i class="icon-shopping-cart" style="color:#3C3"></i> 12.55</div>
