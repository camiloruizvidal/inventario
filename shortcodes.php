                                                ...
                                                <form id="edit-profile" class="form-horizontal">
                                                    <div class="container-fluid">
                                                        ...
                                                        <div class="control-group">											
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" class="col-md-6 form form-control disabled" id="username" value="Example" disabled>
                                                        ...
                                                        <div class="control-group">											
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" class="col-md-6 form form-control" id="firstname" value="John">
                                                            </div> <!-- /controls -->				
                                                        </div> <!-- /control-group -->
                                                        ...
                                                        <div class="control-group">											
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" class="col-md-6 form form-control" id="lastname" value="Donga">
                                                            </div> <!-- /controls -->				
                                                        </div> <!-- /control-group -->
                                                        ...
                                                        <div class="control-group">											
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" class="col-md-4 form form-control" id="email" value="john.donga@egrappler.com">
                                                            </div> <!-- /controls -->				
                                                        </div> <!-- /control-group -->
                                                        ...
                                                        <div class="control-group">											
                                                            ...
                                                            <div class="controls">
                                                                <input type="password" class="col-md-4 form form-control" id="password1" value="thisispassword">
                                                            </div> <!-- /controls -->				
                                                        </div> <!-- /control-group -->
                                                        ...
                                                        <div class="control-group">											
                                                            ...
                                                            <div class="controls">
                                                                <input type="password" class="col-md-4 form form-control" id="password2" value="thisispassword">
                                                            </div> <!-- /controls -->				
                                                        </div> <!-- /control-group -->
                                                        <div class="control-group">											
                                                            ...
                                                            <div class="controls">
                                                                <div class="input-append">
                                                                    <input class="col-md-2 m-wrap form form-control" id="appendedInputButton" type="text">
